<?php
    ...
    $query = "SELECT image_path, CONCAT(product_name_base, ' ', product_name_version) as p_name, color_name
        ...
        GROUP BY image_path ORDER BY image_id DESC";
    ...
    foreach ($conn->get_data($query) as $image)
    {
